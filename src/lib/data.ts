...
export const projects = [
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400.png',
    aiHint: 'casino game',
    tags: ['Unity3D', 'Card Game', 'Multiplayer', 'Photon'],
    link: '#',
    linkText: 'Learn More',
    linkIcon: Play,
    category: 'Games',
  },
  {
    ...
    description: 'A conversational companion with customizable avatars, Wikipedia integration, Text-to-Speech (TTS), voice recognition, and translation features for interactive communication.',
    image: 'https://placehold.co/600x400.png',
    aiHint: 'ai chatbot',
  ...
  },
  {
    ...
    description: 'This innovative app features a chatbot that remembers your name and high scores for a personalized experience. It listens to your preferences, like favorite colors, and adapts the game accordingly.',
    image: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    description: 'A business-focused AI chatbot with voice-to-text, voice response, email notifications, and full custom branding capabilities including logos, colors, and contact buttons.',
    image: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400.png',
    aiHint: 'recipe app',
    tags: ['AI', 'Mobile App', 'Productivity', 'Food'],
    link: '#',
    linkText: 'Learn More',
    linkIcon: Play,
    category: 'Apps',
  },
  {
    ...
    image: 'https://placehold.co/600x400.png',
    aiHint: 'dating app',
    tags: ['Social', 'Mobile App', 'Chat', 'AI Chatbot'],
    link: '#',
    linkText: 'Learn More',
    linkIcon: Play,
    category: 'Apps',
