...
export const projects = [
  ...
  },
  {
    ...
    description: 'Conversational companion with customizable avatars, Wikipedia integration, Text-to-Speech (TTS), voice recognition, and translation features for interactive communication.',
    image: 'https://placehold.co/600x400.png',
    aiHint: 'ai chatbot',
