...
export const games = [
    ...
    },
    {
      ...
      description: 'A 3D open-world sandbox survival game prototype set in a harsh, snowy environment with realistic graphics. Players must build, thrive, and survive against the elements.',
    ...
    {
      title: 'Zord RPG',
      description: 'An ambitious AAA quality game prototype with an amazing combat system and a vast world inspired by epic RPGs like Skyrim.',
    ...
    {
      title: 'TrenchTrials',
      description: 'A 2D side-scrolling beat-em-up game with Web3 capabilities.',
      image: '/Images/portfolio/games/TrenchTrials.png',
      aiHint: 'beat em up',
      tags: ['Unity3D', 'Web3', '2D', 'Action', 'Fighting', 'Side Scroller'],
      link: 'https://youtu.be/-MiM7fYGIGw',
      linkText: 'Watch Video',
      linkIcon: Play,
      category: 'Games',
      platform: 'Web3',
    ...
    {
      title: 'Pirate RPG',
      description: 'A prototype for a 3D pirate-themed role-playing game. (Very early version).',
      image: '/Images/portfolio/games/PirateRPG.png',
      aiHint: 'pirate rpg',
      tags: ['Unity3D', '3D', 'RPG', 'Action', 'Prototype'],
      link: 'https://www.youtube.com/watch?v=lUjLvqlLm_4',
      linkText: 'Watch Video',
      linkIcon: Play,
      category: 'Games',
      platform: 'Web2',
    },
    {
      ...
      description: 'A Web3 top-down shooter game with multiplayer battle royale and offline single-player modes.',
      image: '/Images/portfolio/games/CryptoCommando.png',
      aiHint: 'top-down shooter',
      tags: ['Unity3D', 'Web3', 'Shooting', '3D', 'Multiplayer', 'Single Player', 'Action', 'Battle Royale', 'Top-Down'],
