...
import { IconUnity, IconVisualStudio, IconFigma, IconPhotoshop, IconCSharp, IconPython, IconFirebase, IconPhoton, IconJavascript, IconTypescript, IconXaml, IconReact, IconDotNet, IconVisualStudioCode } from "@/components/icons";
...
export const skills = [
  ...
  { name: "Photon Networking", icon: IconPhoton },
  { name: "XAML", icon: IconXaml },
];
