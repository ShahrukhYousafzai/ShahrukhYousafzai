                 ...
                 <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 mt-2">
                             {fiverrLink && <a href={fiverrLink.url} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Fiverr</a>}
                             {upworkLink && <a href={upworkLink.url} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Upwork</a>}
                        </div>
                    </div>
                 </div>
            </div>
