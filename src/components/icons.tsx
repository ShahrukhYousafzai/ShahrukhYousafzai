...
export const IconVisualStudio = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 193 193" fill="currentColor" {...props}>
      <path d="M40.6 157.5 11.2 135.5c-2.8-2.1-3-4.4-3-6v-66c0-1.6.2-3.9 3-6l29.4-22c.8.7 1.4 1.6 1.7 2.6.4 1 .5 2.1.3 3.2v110.3c.2 1-.1 2.1-..4 3.1s-1 1.9-1.7 2.6zM181.5 38.9c-1.2-.8-2.6-1.2-4.1-1.2s-3.3.4-4.2 1.1l-.5.5-58.7 56.2-32.4 31.2-30 28.8-.5.5c-1.8 1.8-2.6 3.1-4.2 3.1-1.6 0-3.1-.5-4.3-1.5l-29.4-22.1c1.5 1.1 3.4 1.6 5.2 1.4s3.5-.9 4.7-2.3l32.6-37.9L80.7 65.4l46.9-54.6c1.8-2 2.9-2.8 4.6-2.8s3.1.5 4.6 2.1l44.2 29.4zM181.5 154.1 137.3 183.5c-1.5.9-2.9 1.1-4.7.8s-3.3-.9-4.7-2.3L80.7 127.6l-26.8-31.2-16.6-18.9c-1.2-1.4-2.9-2.3-4.8-2.5s-3.6.5-5.1 1.6l29.4-22.1c1.2-1 2.7-1.5 4.3-1.5s3.3.4 4.2 1.1l.5.5L80.7 65.4l32.4 31.1L171.8 152.7l.5.6c1.8 1.8 2.6 3.1 4.2 3.1s3.1-.4 4.1-1.2l44.2-29.4zM184.7 45v103c0 1.2-.3 2.4-..9 3.5s-1.3 2-2.3 2.6l-44.1 29.4c1-..7 1.8-1.6 2.4-2.7s.9-2.3.9-3.5V15.6c0-1.2-.3-2.4-..9-3.5s-1.4-2-2.4-2.6L181.5 38.9c1 .7 1.7 1.6 2.3 2.6s.9 2.3.9 3.5z"/>
    </svg>
);
