...
export const metadata: Metadata = {
  ...
  description:
    'Founder of a creative engineering operation based in Pakistan, shipping worldwide. 9+ years shipping production software. 1M+ app downloads on Google Play. 76+ verified client reviews. Web2, Web3, and AI specialist.',
  keywords: [
    'Shahrukh Yousafzai',
    'AFS Creative Studio',
    'Efface Studios',
  ...
  openGraph: {
    ...
    description:
      'Founder authority behind AFS Creative Studio (creative services), Efface Studios (games product house since 2017), and AFS Agentics (AI product studio). 9+ years. 1M+ downloads. 76+ verified reviews.',
    type: 'website',
